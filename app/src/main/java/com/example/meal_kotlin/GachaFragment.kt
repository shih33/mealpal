...
import com.example.meal_kotlin.databinding.FragmentGachaBinding
...
class GachaFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.gachabtn.setOnClickListener{
            findNavController().navigate(R.id.action_gachaFragment_to_getrtFragment)
        }
    }
